...
{
	public partial class Test_BaseGrid : Form
	{
		...
		public Test_BaseGrid()
		{
			InitializeComponent();
		}

		private void Test_BaseGrid_Load(object sender, System.EventArgs e)
		{
		...
		private void Test_BaseGrid_FormClosing(object sender, FormClosingEventArgs e)
		{
		...
		private void Grid_ToolStrip_Customize()
		{
			...
			Grid.TopToolStrip.Items[0].Visible = false;
			Grid.TopToolStrip.Items[1].Visible = false;
			Grid.TopToolStrip.Items[2].Visible = false;
			Grid.TopToolStrip.Items[3].Visible = false;
